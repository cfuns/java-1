...
@Singleton
public class TaskGuiTaskPrioDecreaseServlet extends WebsiteServlet {
	...
	@Inject
	public TaskGuiTaskPrioDecreaseServlet(
			final Logger logger,
	...
	protected void doService(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws ServletException, IOException {
		try {
			...
			taskService.decreaseTaskPrio(sessionIdentifier, taskIdentifier);
		}
