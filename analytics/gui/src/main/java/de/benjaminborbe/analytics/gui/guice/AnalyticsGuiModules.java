...
public class AnalyticsGuiModules implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(Peaberry.osgiModule(context), new ServletModule(), new AnalyticsGuiOsgiModule(), new AnalyticsGuiModule(), new ToolModule(), new WebsiteOsgiModule());
	}
}
