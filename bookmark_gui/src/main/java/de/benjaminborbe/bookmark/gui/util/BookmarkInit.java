...
public class BookmarkInit {
	...
	public void init(final SessionIdentifier sessionIdentifier) throws BookmarkServiceException {
		// internal
	...
	protected void createBookmark(final SessionIdentifier sessionIdentifier, final String url, final String name) throws BookmarkServiceException {
