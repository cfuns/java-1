...
@Singleton
public class ChecklistGuiEntryCompleteServlet extends ChecklistGuiWebsiteServlet {
	...
	@Inject
	public ChecklistGuiEntryCompleteServlet(
		final Logger logger,
	...
	protected void doService(
		...
		try {
			...
			checklistService.complete(sessionIdentifier, identifier);
