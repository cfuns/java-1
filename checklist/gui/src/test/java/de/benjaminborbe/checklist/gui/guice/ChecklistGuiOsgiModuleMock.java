...
import de.benjaminborbe.checklist.mock.ChecklistServiceMock;
import de.benjaminborbe.navigation.api.NavigationWidget;
import de.benjaminborbe.navigation.mock.NavigationWidgetMock;
import de.benjaminborbe.tools.osgi.mock.ExtHttpServiceMock;
import de.benjaminborbe.tools.osgi.mock.LogServiceMock;

public class ChecklistGuiOsgiModuleMock extends AbstractModule {
	...
	protected void configure() {
		...
		bind(ChecklistService.class).to(ChecklistServiceMock.class).in(Singleton.class);
