...
public class CalendarGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final CalendarGuiServlet calendarServlet = new CalendarGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
