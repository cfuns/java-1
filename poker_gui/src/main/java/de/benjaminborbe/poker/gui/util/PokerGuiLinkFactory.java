...
public class PokerGuiLinkFactory {
	...
	public Widget gameJoin(final HttpServletRequest request, final PokerGameIdentifier pokerGameIdentifier, final PokerPlayerIdentifier pokerPlayerIdentifier)
