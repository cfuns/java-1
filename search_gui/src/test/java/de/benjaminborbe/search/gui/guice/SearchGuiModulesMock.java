...
public class SearchGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new SearchGuiOsgiModuleMock(), new SearchGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
