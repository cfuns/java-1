...
public class PokerCardsPairComparator implements Comparator<Collection<PokerCardIdentifier>> {

	private final PokerCardsHighcardComparator pokerCardsHighcardComparator;

	@Inject
	public PokerCardsPairComparator(final PokerCardsHighcardComparator pokerCardsHighcardComparator) {
