...
public class PokerCardsStraightFlushComparatorUnitTest {

	@Test
	public void testCompareNoCard() throws Exception {
		final PokerCardsStraightFlushComparator comparator = getPokerCardsStraightFlushComparator();
	...
	private PokerCardsStraightFlushComparator getPokerCardsStraightFlushComparator() {
		...
		return new PokerCardsStraightFlushComparator(comparatorUtil, pokerCardUtil, pokerCardComparator);
	}
