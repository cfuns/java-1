...
@Singleton
public class PokerGuiActionCallServlet extends WebsiteHtmlServlet {

	private static final long serialVersionUID = 7727468974460815201L;

	private static final String TITLE = "Poker - Call";
	...
	@Inject
	public PokerGuiActionCallServlet(
		final Logger logger,
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			pokerService.call(pokerGameIdentifier, pokerPlayerIdentifier);
