...
@Singleton
public class PokerGuiGameAddAllAvailablePlayersServlet extends WebsiteHtmlServlet {

	private static final long serialVersionUID = 7727468974460815201L;

	private static final String TITLE = "Poker - Add all available players to game";
	...
	@Inject
	public PokerGuiGameAddAllAvailablePlayersServlet(
		final Logger logger,
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			pokerService.addAllAvailablePlayers(pokerGameIdentifier);
