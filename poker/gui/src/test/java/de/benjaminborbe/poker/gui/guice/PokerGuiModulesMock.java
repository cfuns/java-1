...
public class PokerGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new PokerGuiOsgiModuleMock(), new PokerGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
