...
import de.benjaminborbe.streamcache.mock.StreamcacheServiceMock;
import de.benjaminborbe.tools.osgi.mock.ExtHttpServiceMock;
import de.benjaminborbe.tools.osgi.mock.LogServiceMock;

public class StreamcacheGuiOsgiModuleMock extends AbstractModule {
	...
	protected void configure() {
		...
		bind(StreamcacheService.class).to(StreamcacheServiceMock.class).in(Singleton.class);
