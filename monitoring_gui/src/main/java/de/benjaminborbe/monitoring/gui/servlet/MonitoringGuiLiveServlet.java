...
import de.benjaminborbe.monitoring.gui.service.MonitoringWidget;
...
@Singleton
public class MonitoringGuiLiveServlet extends WebsiteHtmlServlet {

	private static final long serialVersionUID = -3368317580182944276L;

	private static final String TITLE = "Monitoring - Live";

	private final MonitoringWidget monitoringWidget;

	@Inject
	public MonitoringGuiLiveServlet(
			final Logger logger,
			...
			final MonitoringGuiWidgetLive monitoringWidget,
