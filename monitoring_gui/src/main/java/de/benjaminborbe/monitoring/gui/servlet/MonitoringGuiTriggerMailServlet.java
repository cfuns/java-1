...
@Singleton
public class MonitoringGuiTriggerMailServlet extends MonitoringWebsiteHtmlServlet {

	private static final long serialVersionUID = -7863752062438502326L;

	private static final String TITLE = "Monitoring - Trigger - Mail";
	...
	@Inject
	public MonitoringGuiTriggerMailServlet(
			final Logger logger,
	...
	protected Widget createMonitoringContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			monitoringService.mail(sessionIdentifier);
			widgets.add("mail triggered");
			return widgets;
		}
