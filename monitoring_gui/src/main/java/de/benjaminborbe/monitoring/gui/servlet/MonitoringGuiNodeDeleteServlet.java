...
@Singleton
public class MonitoringGuiNodeDeleteServlet extends WebsiteServlet {
	...
	@Inject
	public MonitoringGuiNodeDeleteServlet(
		final Logger logger,
	...
	protected void doService(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws ServletException, IOException,
		...
		try {
			...
			monitoringService.deleteNode(sessionIdentifier, monitoringNodeIdentifier);
