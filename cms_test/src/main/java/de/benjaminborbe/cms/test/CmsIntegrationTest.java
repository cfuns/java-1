...
public class CmsIntegrationTest extends OSGiTestCase {
	...
	public void testCmsService() {
		final Object serviceObject = getServiceObject(CmsService.class.getName(), null);
		final CmsService service = (CmsService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.cms.service.CmsServiceImpl", service.getClass().getName());
	}
