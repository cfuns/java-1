...
public class KioskIntegrationTest extends TestCaseOsgi {
	...
	public void testKioskService() {
		final Object serviceObject = getServiceObject(KioskService.class.getName(), null);
		final KioskService service = (KioskService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.kiosk.service.KioskServiceImpl", service.getClass().getName());
	}
