...
public class OptionsDialog extends JDialog {
	...
	private <T> JRadioButton addRadioButton(final String text, final T state, final RadioButtonSelectedState<T> selected, final Map<T, JRadioButton> state2buttonMap, final JComponent component,
