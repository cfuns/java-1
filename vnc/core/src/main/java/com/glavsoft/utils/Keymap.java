...
public class Keymap {
	...
	private static final Map<Integer, Integer> keyMap = toMap(new int[][]{
		...
		{0x07a9, 0x03ab}, /*
													 * Greek_UPSILONdieresis GREEK CAPITAL LETTER UPSILON WITH
													 * DIALYTIKA
													 */
		...
		{0x07b6, 0x0390}, /*
													 * Greek_iotaaccentdieresis GREEK SMALL LETTER IOTA WITH
													 * DIALYTIKA AND TONOS
													 */
		...
		{0x07b9, 0x03cb}, /*
													 * Greek_upsilondieresis GREEK SMALL LETTER UPSILON WITH
													 * DIALYTIKA
													 */
		{0x07ba, 0x03b0}, /*
													 * Greek_upsilonaccentdieresis GREEK SMALL LETTER UPSILON WITH
													 * DIALYTIKA AND TONOS
													 */
