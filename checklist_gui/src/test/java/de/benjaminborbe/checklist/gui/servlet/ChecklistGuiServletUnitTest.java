...
public class ChecklistGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final ChecklistGuiServlet checklistServlet = new ChecklistGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
				redirectUtil, urlUtil);

		checklistServlet.service(request, response);
		final String content = sw.getBuffer().toString();
		assertNotNull(content);
		assertTrue(content.indexOf("<h1>Checklist</h1>") != -1);
	}
}
