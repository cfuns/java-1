...
public abstract class ChecklistGuiWebsiteHtmlServlet extends WebsiteHtmlServlet {
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		return new DivWidget(createChecklistContentWidget(request)).addClass("checklist");
	}

	protected abstract Widget createChecklistContentWidget(final HttpServletRequest request) throws IOException,
		PermissionDeniedException, RedirectException, LoginRequiredException;
