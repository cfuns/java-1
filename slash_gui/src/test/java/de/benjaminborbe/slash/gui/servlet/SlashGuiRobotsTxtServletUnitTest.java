...
public class SlashGuiRobotsTxtServletUnitTest {
	...
	public void testRender() throws Exception {
		...
		final StringWriter expectedContent = new StringWriter();
		expectedContent.append("User-agent: *");
		expectedContent.append("\n");
		expectedContent.append("Disallow: /css/");
		expectedContent.append("\n");
		expectedContent.append("Disallow: /images/");
		expectedContent.append("\n");
