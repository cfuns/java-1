...
public class LuceneIndexGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final LuceneIndexGuiServlet indexServlet = new LuceneIndexGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget,
		...
		assertTrue(content.indexOf("<h1>LuceneIndex</h1>") != -1);
	}
}
