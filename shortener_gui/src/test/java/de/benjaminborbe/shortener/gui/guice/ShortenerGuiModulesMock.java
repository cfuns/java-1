...
public class ShortenerGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new ShortenerGuiOsgiModuleMock(), new ShortenerGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
