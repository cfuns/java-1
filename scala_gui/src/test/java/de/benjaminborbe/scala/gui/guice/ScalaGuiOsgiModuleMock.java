...
import de.benjaminborbe.scala.mock.ScalaServiceMock;
import de.benjaminborbe.tools.osgi.mock.ExtHttpServiceMock;
import de.benjaminborbe.tools.osgi.mock.LogServiceMock;

public class ScalaGuiOsgiModuleMock extends AbstractModule {
	...
	protected void configure() {
		...
		bind(ScalaService.class).to(ScalaServiceMock.class).in(Singleton.class);
