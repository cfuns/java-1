...
public class BookmarkModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new BookmarkOsgiModuleMock(), new BookmarkModule(), new ToolModuleMock(), new ValidationModule());
	}
}
