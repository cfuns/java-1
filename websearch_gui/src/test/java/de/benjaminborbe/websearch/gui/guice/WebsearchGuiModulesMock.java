...
public class WebsearchGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new WebsearchGuiOsgiModuleMock(), new WebsearchGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
