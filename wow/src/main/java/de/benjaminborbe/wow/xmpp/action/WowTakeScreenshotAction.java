...
public class WowTakeScreenshotAction extends WowActionBase {
	...
	public WowTakeScreenshotAction(final Logger logger, final VncService vncService, final String name, final ThreadResult<Boolean> running, final ThreadResult<VncPixels> pixelsBeforeFishing) {
