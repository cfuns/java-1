...
public class WowGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final WowGuiServlet wowServlet = new WowGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
