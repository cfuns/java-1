...
public class WowGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final WowGuiServlet wowServlet = new WowGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider, redirectUtil,
				urlUtil);

		wowServlet.service(request, response);
		final String content = sw.getBuffer().toString();
		assertNotNull(content);
		assertTrue(content.indexOf("<h1>Wow</h1>") != -1);
	}
}
