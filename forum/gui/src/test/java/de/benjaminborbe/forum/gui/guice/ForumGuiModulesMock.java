...
public class ForumGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new ForumGuiOsgiModuleMock(), new ForumGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
