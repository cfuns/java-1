...
public class RemoteLabel implements java.io.Serializable {
	...
	public RemoteLabel(final long id, final java.lang.String name, final java.lang.String namespace, final java.lang.String owner) {
		this.id = id;
		this.name = name;
	...
	public synchronized boolean equals(final java.lang.Object obj) {
		if (!(obj instanceof RemoteLabel))
			return false;
		final RemoteLabel other = (RemoteLabel) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
