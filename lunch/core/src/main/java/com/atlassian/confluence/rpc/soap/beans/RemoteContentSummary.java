...
public class RemoteContentSummary implements java.io.Serializable {
	...
	public synchronized boolean equals(final java.lang.Object obj) {
		if (!(obj instanceof RemoteContentSummary))
			return false;
		final RemoteContentSummary other = (RemoteContentSummary) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	// Type metadata
	private static final org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(RemoteContentSummary.class, true);
