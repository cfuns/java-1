...
public class RemotePageUpdateOptions implements java.io.Serializable {
	...
	public RemotePageUpdateOptions(final boolean minorEdit, final java.lang.String versionComment) {
	...
	public synchronized boolean equals(final java.lang.Object obj) {
		if (!(obj instanceof RemotePageUpdateOptions))
			return false;
		final RemotePageUpdateOptions other = (RemotePageUpdateOptions) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
