...
public class ConfluenceSoapServiceServiceLocator extends org.apache.axis.client.Service implements net.seibertmedia.kunden.ConfluenceSoapServiceService {
    ...
    public net.seibertmedia.kunden.ConfluenceSoapService getConfluenceserviceV1(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.seibertmedia.kunden.ConfluenceserviceV1SoapBindingStub _stub = new net.seibertmedia.kunden.ConfluenceserviceV1SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.seibertmedia.kunden.ConfluenceSoapService.class.isAssignableFrom(serviceEndpointInterface)) {
                net.seibertmedia.kunden.ConfluenceserviceV1SoapBindingStub _stub = new net.seibertmedia.kunden.ConfluenceserviceV1SoapBindingStub(new java.net.URL(ConfluenceserviceV1_address), this);
                _stub.setPortName(getConfluenceserviceV1WSDDServiceName());
                return _stub;
            }
        }
