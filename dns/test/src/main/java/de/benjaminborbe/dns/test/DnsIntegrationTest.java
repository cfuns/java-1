...
public class DnsIntegrationTest extends TestCaseOsgi {
	...
	public void testDnsService() throws Exception {
		final Object serviceObject = getServiceObject(DnsService.class.getName(), null);
		final DnsService service = (DnsService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.dns.core.service.DnsCoreServiceImpl", service.getClass().getName());
	}
