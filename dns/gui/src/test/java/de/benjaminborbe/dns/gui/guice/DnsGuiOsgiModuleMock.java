...
import de.benjaminborbe.dns.mock.DnsServiceMock;
...
public class DnsGuiOsgiModuleMock extends AbstractModule {
	...
	protected void configure() {
		...
		bind(DnsService.class).to(DnsServiceMock.class).in(Singleton.class);
