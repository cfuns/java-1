...
public class LogglyIntegrationTest extends TestCaseOsgi {
	...
	public void testLogglyService() {
		final Object serviceObject = getServiceObject(LogglyService.class.getName(), null);
		final LogglyService service = (LogglyService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.loggly.service.LogglyServiceImpl", service.getClass().getName());
	}
