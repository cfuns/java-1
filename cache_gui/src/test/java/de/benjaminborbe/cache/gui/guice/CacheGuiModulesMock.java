...
public class CacheGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new CacheGuiOsgiModuleMock(), new CacheGuiModule(), new ToolModule(), new WebsiteOsgiModuleMock());
	}
}
