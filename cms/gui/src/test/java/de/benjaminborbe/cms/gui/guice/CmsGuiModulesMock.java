...
public class CmsGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new CmsGuiOsgiModuleMock(), new CmsGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
