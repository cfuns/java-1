...
public class GwtGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final GwtGuiServlet gwtServlet = new GwtGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
