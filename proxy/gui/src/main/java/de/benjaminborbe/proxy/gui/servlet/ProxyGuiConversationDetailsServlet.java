...
@Singleton
public class ProxyGuiConversationDetailsServlet extends WebsiteHtmlServlet {

	private static final long serialVersionUID = 1328676176772634649L;

	private static final String TITLE = "Proxy - Conversation - Details";
	...
	@Inject
	public ProxyGuiConversationDetailsServlet(
		final Logger logger,
