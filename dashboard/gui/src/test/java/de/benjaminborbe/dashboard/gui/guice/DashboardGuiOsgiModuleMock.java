...
import de.benjaminborbe.dashboard.mock.DashboardServiceMock;
...
public class DashboardGuiOsgiModuleMock extends AbstractModule {

	@Override
	protected void configure() {
		bind(DashboardService.class).to(DashboardServiceMock.class).in(Singleton.class);
