...
@Singleton
public class DhlGuiTriggerCheckServlet extends WebsiteHtmlServlet {
	...
	@Inject
	public DhlGuiTriggerCheckServlet(
		final Logger logger,
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			dhlService.triggerCheck(sessionIdentifier);
			widgets.add("status update triggered");
			return widgets;
