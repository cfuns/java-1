...
public class KioskGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final KioskGuiServlet kioskServlet = new KioskGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
				redirectUtil, urlUtil, authorizationService);

		kioskServlet.service(request, response);
		final String content = sw.getBuffer().toString();
		assertNotNull(content);
		assertTrue(content.indexOf("<h1>Kiosk</h1>") != -1);
	}
}
