...
public class MessageserviceGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final MessageserviceGuiServlet messageserviceServlet = new MessageserviceGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget,
