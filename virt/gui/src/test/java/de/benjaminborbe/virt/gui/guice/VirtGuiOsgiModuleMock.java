...
import de.benjaminborbe.virt.mock.VirtServiceMock;
import de.benjaminborbe.tools.osgi.mock.ExtHttpServiceMock;
import de.benjaminborbe.tools.osgi.mock.LogServiceMock;

public class VirtGuiOsgiModuleMock extends AbstractModule {
	...
	protected void configure() {
		...
		bind(VirtService.class).to(VirtServiceMock.class).in(Singleton.class);
