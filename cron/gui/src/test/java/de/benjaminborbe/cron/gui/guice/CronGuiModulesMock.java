...
public class CronGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new CronGuiOsgiModuleMock(), new CronGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
