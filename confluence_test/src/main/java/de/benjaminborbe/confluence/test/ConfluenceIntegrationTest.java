...
public class ConfluenceIntegrationTest extends OSGiTestCase {
	...
	public void testConfluenceService() {
		final Object serviceObject = getServiceObject(ConfluenceService.class.getName(), null);
		final ConfluenceService service = (ConfluenceService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.confluence.service.ConfluenceServiceImpl", service.getClass().getName());
	}
