...
public class ImagedownloaderIntegrationTest extends TestCaseOsgi {
	...
	public void testImagedownloaderService() throws Exception {
		final Object serviceObject = getServiceObject(ImagedownloaderService.class.getName(), null);
		final ImagedownloaderService service = (ImagedownloaderService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.imagedownloader.core.service.ImagedownloaderCoreServiceImpl", service.getClass().getName());
	}
