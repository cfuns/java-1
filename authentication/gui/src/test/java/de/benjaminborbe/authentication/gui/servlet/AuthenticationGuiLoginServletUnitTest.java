...
public class AuthenticationGuiLoginServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final AuthenticationGuiLoginServlet authenticationServlet = new AuthenticationGuiLoginServlet(logger, calendarUtil, timeZoneUtil, parseUtil, navigationWidget,
			httpContextProvider, authenticationService, urlUtil, authorizationService, authenticationGuiConfig, cacheService, null);
