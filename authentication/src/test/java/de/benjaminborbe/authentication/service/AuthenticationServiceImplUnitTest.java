...
public class AuthenticationServiceImplUnitTest {
	...
	public void testVerifyCredential() throws Exception {
		...
		final AuthenticationService authenticationService = new AuthenticationServiceImpl(logger, null, null, null, null, sessionDao, userDao, null, null, null, null, durationUtil, v);
	...
	public void testGetCurrentUserExists() throws Exception {
		...
		final AuthenticationService authenticationService = new AuthenticationServiceImpl(logger, null, null, null, null, sessionDao, userDao, null, null, null, null, durationUtil,
				null);
