...
public class WikiPageBeanMapper extends MapObjectMapperAdapter<WikiPageBean> {
	...
	public WikiPageBeanMapper(
		...
		super(provider, buildMappings(mapperWikiPageIdentifier, mapperString, mapperWikiSpaceIdentifier, mapperCalendar));
	}
	...
	private static Collection<StringObjectMapper<WikiPageBean>> buildMappings(final MapperWikiPageIdentifier mapperWikiPageIdentifier, final MapperString mapperString,
			final MapperWikiSpaceIdentifier mapperWikiSpaceIdentifier, final MapperCalendar mapperCalendar) {
		...
		result.add(new StringObjectMapperAdapter<WikiPageBean, String>("contentType", mapperString));
