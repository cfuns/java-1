...
import de.benjaminborbe.websearch.configuration.WebsearchConfigurationDaoImpl;
...
public class WebsearchModule extends AbstractModule {
	...
	protected void configure() {
		...
		bind(WebsearchConfigurationDao.class).to(WebsearchConfigurationDaoImpl.class).in(Singleton.class);
