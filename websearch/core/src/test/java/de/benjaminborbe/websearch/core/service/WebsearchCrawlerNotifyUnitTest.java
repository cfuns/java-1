...
public class WebsearchCrawlerNotifyUnitTest {
    ...
    public void testPageAttributes() throws Exception {
        ...
        final WebsearchUpdatePageCrawlerNotify websearchUpdatePageCrawlerNotify = new WebsearchUpdatePageCrawlerNotify(logger, calendarUtil, websearchPageDao);
        websearchUpdatePageCrawlerNotify.notifiy(httpResponse);
