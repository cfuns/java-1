...
public class DistributedIndexGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new DistributedIndexGuiOsgiModuleMock(), new DistributedIndexGuiModule(), new ToolModuleMock(),
