...
public class DistributedSearchGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new DistributedSearchGuiOsgiModuleMock(), new DistributedSearchGuiModule(), new ToolModule(),
				new WebsiteModule());
	}
}
