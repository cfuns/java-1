...
public class MonitoringGuiModules implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(Peaberry.osgiModule(context), new ServletModule(), new MonitoringGuiOsgiModule(), new MonitoringGuiModule(), new ToolModule(), new WebsiteOsgiModule());
	}
}
