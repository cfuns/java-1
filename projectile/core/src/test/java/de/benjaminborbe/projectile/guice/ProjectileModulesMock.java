...
public class ProjectileModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new ProjectileOsgiModuleMock(), new ProjectileModule(), new ToolModuleMock(), new ValidationModule());
	}
}
