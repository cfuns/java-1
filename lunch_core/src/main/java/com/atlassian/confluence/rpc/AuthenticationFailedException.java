...
public class AuthenticationFailedException extends com.atlassian.confluence.rpc.RemoteException implements java.io.Serializable {
	...
	public synchronized boolean equals(final java.lang.Object obj) {
		if (!(obj instanceof AuthenticationFailedException))
			return false;
		final AuthenticationFailedException other = (AuthenticationFailedException) obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	// Type metadata
	private static final org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(AuthenticationFailedException.class, true);
