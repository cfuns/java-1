...
public class FilestorageEntryBeanMapper extends MapObjectMapperAdapter<FilestorageEntryBean> {
	...
	public FilestorageEntryBeanMapper(
		...
		final MapperCalendar mapperCalendar, final MapperFilestorageEntryIdentifier mapperFilestorageEntryIdentifier, final MapperString mapperString, final MapperByteArray mapperByteArray) {
		super(provider, buildMappings(mapperCalendar, mapperFilestorageEntryIdentifier, mapperString, mapperByteArray));
	}

	private static Collection<StringObjectMapper<FilestorageEntryBean>> buildMappings(final MapperCalendar mapperCalendar, final MapperFilestorageEntryIdentifier mapperFilestorageEntryIdentifier, final MapperString mapperString, final MapperByteArray mapperByteArray) {
