...
import de.benjaminborbe.note.gui.guice.NoteGuiModule;
...
public class NoteGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays
				.asList(new PeaberryModuleMock(), new ServletModuleMock(), new NoteGuiOsgiModuleMock(), new NoteGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
