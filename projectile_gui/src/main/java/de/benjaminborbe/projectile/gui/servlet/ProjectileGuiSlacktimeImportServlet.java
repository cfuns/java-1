...
@Singleton
public class ProjectileGuiSlacktimeImportServlet extends WebsiteHtmlServlet {

	private static final String TITLE = "Projectile - Slacktime - Import";
	...
	@Inject
	public ProjectileGuiSlacktimeImportServlet(
			final Logger logger,
