...
import de.benjaminborbe.projectile.mock.ProjectileServiceMock;
import de.benjaminborbe.tools.osgi.mock.ExtHttpServiceMock;
import de.benjaminborbe.tools.osgi.mock.LogServiceMock;

public class ProjectileGuiOsgiModuleMock extends AbstractModule {

	@Override
	protected void configure() {
		bind(AuthenticationService.class).to(AuthenticationServiceMock.class).in(Singleton.class);
		bind(ProjectileService.class).to(ProjectileServiceMock.class).in(Singleton.class);
