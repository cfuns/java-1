package de.benjaminborbe.checklist.test;
...
public class ChecklistIntegrationTest extends TestCaseOsgi {
	...
	public void testChecklistService() {
		final Object serviceObject = getServiceObject(ChecklistService.class.getName(), null);
		final ChecklistService service = (ChecklistService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.checklist.service.ChecklistServiceImpl", service.getClass().getName());
	}
