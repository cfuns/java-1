...
public class DistributedSearchModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new DistributedSearchOsgiModuleMock(), new DistributedSearchModule(), new ToolModuleMock(), new ValidationModule());
	}
}
