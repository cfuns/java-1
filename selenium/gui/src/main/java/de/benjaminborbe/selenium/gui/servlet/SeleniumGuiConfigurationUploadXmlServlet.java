...
@Singleton
public class SeleniumGuiConfigurationUploadXmlServlet extends WebsiteHtmlServlet {
	...
	@Inject
	public SeleniumGuiConfigurationUploadXmlServlet(
		final Logger logger,
	...
	protected Widget createContentWidget(
		...
		try {
			...
			if (xml != null) {
				seleniumConfigurationXmlService.addXml(xml);
				widgets.add("xml added");
			}
