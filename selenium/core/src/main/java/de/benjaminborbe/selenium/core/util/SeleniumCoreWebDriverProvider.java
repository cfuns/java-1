...
public class SeleniumCoreWebDriverProvider implements Provider<SeleniumCoreWebDriver> {
	...
	private final SeleniumLocalWebDriverCreator seleniumLocalWebDriverCreator;
	...
	public SeleniumCoreWebDriverProvider(
		...
		final SeleniumLocalWebDriverCreator seleniumLocalWebDriverCreator
	) {
		this.logger = logger;
		...
		this.seleniumLocalWebDriverCreator = seleniumLocalWebDriverCreator;
	}
	...
	public SeleniumCoreWebDriver get() {
		...
		try {
			...
			if (Boolean.TRUE.equals(seleniumCoreConfig.getSeleniumLocal())) {
				...
				driver = seleniumLocalWebDriverCreator.create();
			} else {
