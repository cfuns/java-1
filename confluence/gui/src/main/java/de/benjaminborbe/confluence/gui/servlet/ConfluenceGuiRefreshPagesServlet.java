...
public class ConfluenceGuiRefreshPagesServlet extends WebsiteHtmlServlet {
	...
	@Inject
	public ConfluenceGuiRefreshPagesServlet(
		final Logger logger,
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			if (confluenceService.refreshPages(sessionIdentifier)) {
