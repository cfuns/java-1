...
public class KioskGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new KioskGuiOsgiModuleMock(), new KioskGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
