...
(function (T, aa, p) {
	...
	function pb(b) {
		...
		var h =
		{}, f = "Provider", i = [], j = new Fa, k = {$provide: {provider: a(c), factory: a(d), service: a(function (a, b) {
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler",
			"$http", "$templateCache", "$parse", "$controller", "$rootScope", function (b, i, j, k, l, n, r, o) {
				...
				function V(a, b, c, d, e, f, j) {
					var i =
						[], n, o, r = c[0], q = a.shift(), w = D({}, q, {controller: null, templateUrl: null, transclude: null});
					c.html("");
	...
	function ua(b, a) {
		var c = Fb.exec(b), c = {protocol: c[1], host: c[3], port: H(c[5]) || Gb[c[1]] || null, path: c[6] || "/", search: c[8], hash: c[10]};
	...
	function Jc(b, a) {
		...
		function k() {
			...
			n.push(d);
			i && (n.push({index: f, text: ".", json: !1}), n.push({index: f +
				1, text: i, json: !1}))
		}
		...
		function l(a) {
			...
			for (var d = "", f = a, e = !1; o < b.length;) {
				...
				if (e)j == "u" ? (j = b.substring(o + 1, o + 5), j.match(/[\da-f]{4}/i) || i("Invalid unicode escape [\\u" + j + "]"), o += 4, d += String.fromCharCode(parseInt(j, 16))) : (e = Kc[j], d += e ? e : j), e = !1; else if (j == "\\")e = !0; else if (j == a) {
					o++;
					n.push({index: c, text: f, string: d, json: !0, fn: function () {
						return d
					}});
					return
				} else d += j;
		...
		for (var n = [], r, o = 0, w = [], q, t = ":"; o < b.length;) {
			...
			} else if (c("(){}[].,;:"))n.push({index: o, text: q, json: ":[,".indexOf(t) != -1 && c("{[") || c("}]:,")}), c("{[") && w.unshift(q), c("}]") && w.shift(), o++; else if (g(q)) {
				o++;
				continue
			} else {
				var m = q + d(), A = Ka[q], y = Ka[m];
				y ? (n.push({index: o, text: m, fn: y}), o += 2) : A ? (n.push({index: o, text: q, fn: A, json: "[,:".indexOf(t) != -1 && c("+-")}), o += 1) : i("Unexpected next character ", o, o + 1)
			}
			t = q
		}
		return n
	...
	function Pc() {
		...
		this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$http", "$templateCache", function (a, c, d, e, g, h, f) {
			...
			function j() {
				var a, d;
				m(b, function (b, e) {
					if (!d && (a = l(c.path(), e)))d = xa(b, {params: D({}, c.search(), a), pathParams: a}), d.$route = b
				});
	...
	function Rc() {
		...
		this.$get = ["$injector", "$exceptionHandler", "$parse", function (a, c, d) {
			...
			e.prototype = {$new: function (a) {
				...
				}, defaultPrevented: !1}, h = [i].concat(ga.call(arguments, 1)), m, p;
				do {
					e = f.$$listeners[a] || d;
					i.currentScope = f;
					m = 0;
				...
				}, defaultPrevented: !1}, g = [f].concat(ga.call(arguments, 1));
	...
	function Uc() {
		var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = this.defaults = {transformResponse: [function (d) {
			...
			"X-Requested-With": "XMLHttpRequest"}, post: {"Content-Type": "application/json;charset=utf-8"}, put: {"Content-Type": "application/json;charset=utf-8"}}}, e = this.responseInterceptors = [];
	...
	var jc = /[A-Z]/g, hd = {full: "1.0.1", major: 1, minor: 0, dot: 1, codeName: "thorium-shielding"}, Ba = P.cache = {}, Aa = P.expando = "ng-" + (new Date).getTime(), nc = 1, id = T.document.addEventListener ? function (b, a, c) {
	...
	}, lc = /([\:\-\_]+(.))/g, mc = /^moz([A-Z])/, ta = P.prototype = {ready: function (b) {
		function a() {
			c || (c = !0, b())
		}
	...
	m({removeData: rb, dealoc: ra, bind: function a(c, d, e) {
		var g = ca(c, "events"),
			h = ca(c, "handle");
		g || ca(c, "events", g = {});
	...
	db.prototype = {push: function (a, c) {
		var d = this[a = ia(a)];
		d ? d.push(c) : this[a] = [c]
	}, shift: function (a) {
		var c = this[a = ia(a)];
	...
	Bb.$inject = ["$provide"];
	var zc = /^(x[\:\-_]|data[\:\-_])/i,
		Fb = /^([^:]+):\/\/(\w+:{0,1}\w*@)?([\w\.-]*)(:([0-9]+))?(\/[^\?#]*)?(\?([^#]*))?(#(.*))?$/, Zb = /^([^\?#]*)?(\?([^#]*))?(#(.*))?$/, Gc = Zb, Gb = {http: 80, https: 443, ftp: 21};
	fb.prototype = {$$replace: !1, absUrl: Ja("$$absUrl"), url: function (a, c) {
	...
	Qb.$inject = ["$locale"];
	Sb.$inject = ["$locale"];
	var Vb = ".", gd = {yyyy: O("FullYear", 4), yy: O("FullYear", 2, 0, !0), y: O("FullYear", 1), MMMM: La("Month"), MMM: La("Month", !0), MM: O("Month", 2, 1), M: O("Month", 1, 1), dd: O("Date", 2), d: O("Date", 1), HH: O("Hours", 2), H: O("Hours", 1), hh: O("Hours", 2, -12), h: O("Hours", 1, -12), mm: O("Minutes", 2), m: O("Minutes", 1), ss: O("Seconds", 2), s: O("Seconds", 1), EEEE: La("Day"), EEE: La("Day", !0), a: function (a, c) {
	...
	var cd = B(C), dd = B(la);
	Tb.$inject = ["$parse"];
	var jd = B({restrict: "E", compile: function (a, c) {
		c.href || c.$set("href", "");
		return function (a, c) {
	...
	var Ra = {name: "form", restrict: "E", controller: Wb, compile: function () {
		...
		}, hidden: x, button: x, submit: x, reset: x}, ac = ["$browser", "$sniffer", function (a, c) {
		...
		}], yd = ib("", !0), zd = ib("Odd", 0), Ad = ib("Even", 1), Bd = R({compile: function (a, c) {
			c.$set("ngCloak", p);
	...
	var Ed = R(function (a, c, d) {
	...
	}), Nd = B({restrict: "EA", compile: function (a, c) {
		...
		return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
			...
			function l(e, f, g) {
				function i() {
					...
					t = !1;
					var B, C;
					if (o)t = new Fa(s); else if (s === null || q)a[""].push({selected: s === null, id: "", label: ""}), t = !0;
					...
					for (y = c.length; w < y; w++) {
						...
						h = a[d];
						if (v.length <=
							w)s = {element: A.clone().attr("label", d), label: h.label}, u = [s], v.push(u), f.append(s.element); else if (u = v[w], s = u[0], s.label != d)s.element.attr("label", s.label = d);
						B = null;
						x = 0;
						...
						} else d.id === "" && q ? C = q : (C = D.clone()).val(d.id).attr("selected", d.selected).text(d.label), u.push({element: C, label: d.label, id: d.id,
							selected: d.selected}), B ? B.after(C) : s.element.append(C), B = C;
		...
		return{restrict: "E", priority: 100, require: "^select", compile: function (d, e) {
			if (v(e.value)) {
				var g = a(d.text(), !0);
	...
	(ha = T.jQuery) ? (u = ha, D(ha.fn, {scope: ta.scope, controller: ta.controller, injector: ta.injector, inheritedData: ta.inheritedData}), ab("remove", !0), ab("empty"), ab("html")) : u = P;
	Yb.element = u;
	(function (a) {
		...
		sa("ng", ["ngLocale"], ["$provide", function (a) {
			a.provider("$compile", Bb).directive({a: jd, input: ac, textarea: ac, form: kd, script: Sd, select: Ud, style: Wd, option: Vd, ngBind: vd, ngBindHtmlUnsafe: xd, ngBindTemplate: wd, ngClass: yd,
				ngClassEven: Ad, ngClassOdd: zd, ngCsp: Dd, ngCloak: Bd, ngController: Cd, ngForm: ld, ngHide: Ld, ngInclude: Fd, ngInit: Gd, ngNonBindable: Hd, ngPluralize: Id, ngRepeat: Jd, ngShow: Kd, ngSubmit: Ed, ngStyle: Md, ngSwitch: Nd, ngSwitchWhen: Od, ngSwitchDefault: Pd, ngOptions: Td, ngView: Rd, ngTransclude: Qd, ngModel: qd, ngList: sd, ngChange: rd, required: bc, ngRequired: bc, ngValue: ud}).directive(jb).directive(cc);
			a.provider({$anchorScroll: tc, $browser: vc, $cacheFactory: wc, $controller: Ac, $document: Bc, $exceptionHandler: Cc, $filter: Pb, $interpolate: Dc,
