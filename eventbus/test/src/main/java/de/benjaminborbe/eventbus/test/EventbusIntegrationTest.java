...
public class EventbusIntegrationTest extends TestCaseOsgi {
	...
	public void testEventbus() {
		...
		assertEquals(0, eventbusService.getHandlerCount(EventbusInitializedEvent.TYPE));
		assertFalse(eventbusService.isEventHandled(EventbusInitializedEvent.TYPE));
		eventbusService.addHandler(EventbusInitializedEvent.TYPE, new EventbusInitializedEventHandler() {
		...
		assertTrue(eventbusService.isEventHandled(EventbusInitializedEvent.TYPE));
