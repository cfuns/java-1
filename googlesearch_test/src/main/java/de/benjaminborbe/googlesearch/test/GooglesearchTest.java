...
public class GooglesearchTest extends OSGiTestCase {
	...
	@Test
	public void testGooglesearchService() {
		final Object serviceObject = getServiceObject(GooglesearchService.class.getName(), null);
		final GooglesearchService service = (GooglesearchService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.googlesearch.service.GooglesearchServiceImpl", service.getClass().getName());
	}
