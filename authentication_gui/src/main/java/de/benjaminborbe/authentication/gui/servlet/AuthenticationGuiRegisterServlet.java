...
public class AuthenticationGuiRegisterServlet extends WebsiteHtmlServlet {
	...
	private static final String PARAMETER_FULLNAME = "fullname";
	...
	protected Widget createContentWidget(final HttpServletRequest request, final HttpServletResponse response, final HttpContext context) throws IOException,
		...
		try {
			...
			final String fullname = request.getParameter(PARAMETER_FULLNAME);
			...
			form.addFormInputWidget(new FormInputTextWidget(PARAMETER_FULLNAME).addLabel("Fullname").addPlaceholder("Fullname ..."));
