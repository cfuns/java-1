...
public class GalleryImageBeanMapper extends MapObjectMapperAdapter<GalleryImageBean> {
	...
	private static Collection<StringObjectMapper<GalleryImageBean>> buildMappings(final MapperGalleryImageIdentifier mapperGalleryImageIdentifier, final MapperString mapperString,
		...
		result.add(new StringObjectMapperBase<GalleryImageBean, GalleryImageIdentifier>("id", mapperGalleryImageIdentifier));
		result.add(new StringObjectMapperBase<GalleryImageBean, String>("contentType", mapperString));
		result.add(new StringObjectMapperBase<GalleryImageBean, String>("name", mapperString));
		result.add(new StringObjectMapperBase<GalleryImageBean, byte[]>("content", mapperByteArray));
		result.add(new StringObjectMapperBase<GalleryImageBean, Calendar>("created", mapperCalendar));
		result.add(new StringObjectMapperBase<GalleryImageBean, Calendar>("modified", mapperCalendar));
		return result;
	}
}
