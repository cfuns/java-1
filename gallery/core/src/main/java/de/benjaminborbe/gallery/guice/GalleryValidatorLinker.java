...
public class GalleryValidatorLinker {
	...
	@Inject
	public static void link(final ValidatorRegistry validatorRegistry, final GalleryGroupValidator galleryGroupValidator, final GalleryImageValidator galleryImageValidator,
