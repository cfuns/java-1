...
@Singleton
public class SearchOsdServlet extends HttpServlet {
	...
	public void service(final HttpServletRequest request, final HttpServletResponse response) throws ServletException,
		...
		out.println("<Url type=\"application/x-suggestions+json\" method=\"get\" rel=\"suggestions\" template=\"" + baseUrl
				+ "/search/suggest?q={searchTerms}\" />");
		...
		out.println("<Query role=\"example\" searchTerms=\"Sample\" />");
