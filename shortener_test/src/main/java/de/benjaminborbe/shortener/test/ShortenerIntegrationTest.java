...
public class ShortenerIntegrationTest extends TestCaseOsgi {
	...
	public void testShortenerService() {
		final Object serviceObject = getServiceObject(ShortenerService.class.getName(), null);
		final ShortenerService service = (ShortenerService) serviceObject;
		assertNotNull(service);
		assertEquals("de.benjaminborbe.shortener.service.ShortenerServiceImpl", service.getClass().getName());
	}
