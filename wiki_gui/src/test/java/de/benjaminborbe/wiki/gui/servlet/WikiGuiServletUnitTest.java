...
public class WikiGuiServletUnitTest {
	...
	public void testService() throws Exception {
		...
		final WikiGuiServlet wikiServlet = new WikiGuiServlet(logger, calendarUtil, timeZoneUtil, parseUtil, authenticationService, navigationWidget, httpContextProvider,
				redirectUtil, urlUtil);

		wikiServlet.service(request, response);
		final String content = sw.getBuffer().toString();
		assertNotNull(content);
		assertTrue(content.indexOf("<h1>Wiki</h1>") != -1);
	}
}
