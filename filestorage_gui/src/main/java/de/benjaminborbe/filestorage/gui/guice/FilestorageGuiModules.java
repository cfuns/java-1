...
public class FilestorageGuiModules implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(Peaberry.osgiModule(context), new ServletModule(), new FilestorageGuiOsgiModule(), new FilestorageGuiModule(), new ToolModule(), new WebsiteModule());
	}
}
