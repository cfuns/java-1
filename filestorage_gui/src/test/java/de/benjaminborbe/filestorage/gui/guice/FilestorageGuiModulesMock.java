...
public class FilestorageGuiModulesMock implements Modules {
	...
	public Collection<Module> getModules() {
		return Arrays.asList(new PeaberryModuleMock(), new ServletModuleMock(), new FilestorageGuiOsgiModuleMock(), new FilestorageGuiModule(), new ToolModuleMock(), new WebsiteOsgiModuleMock());
	}
}
