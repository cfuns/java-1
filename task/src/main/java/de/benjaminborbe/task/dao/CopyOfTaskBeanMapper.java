...
@Singleton
public class CopyOfTaskBeanMapper extends BaseMapper<TaskBean> {
	...
	@Inject
	public CopyOfTaskBeanMapper(final Provider<TaskBean> provider, final CalendarUtil calendarUtil, final ParseUtil parseUtil) {
		super(provider);
	...
	public void map(final TaskBean object, final Map<String, String> data) {
		...
		data.put(COMPLETED, toString(object.getCompleted()));
