...
public interface TaskServiceTaskContext {
	...
	TaskContextIdentifier createTaskContext(
		SessionIdentifier sessionIdentifier,
		String name
	) throws TaskServiceException, PermissionDeniedException, ValidationException,
	...
	TaskContext getTaskContextByName(
		SessionIdentifier sessionIdentifier,
